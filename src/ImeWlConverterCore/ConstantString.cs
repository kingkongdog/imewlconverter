...
public class ConstantString
{
    ...
    public const string GBOARD = "Gboard";
    ...
    public const string GBOARD_C = "gboard";
    ...
    public const string WIN10_MS_PINYIN_SELF_STUDY_C = "win10mspyss";
    ...
    public const string RIME_C_WITH_TONE_INCLUDE_ENGLISH_BY_MS_PINYIN = "rime_with_tone_include_english_by_ms_pinyin";
